...
export default function ChangePasswordScreen({ navigation }: any) {
  ...
  const fields = [
    { label: t.changePwCurrentLabel, value: currentPw, set: setCurrentPw, show: showCurrent, toggle: setShowCurrent },
    { label: t.changePwNewLabel, value: newPw, set: setNewPw, show: showNew, toggle: setShowNew },
    { label: t.changePwConfirmLabel, value: confirmPw, set: setConfirmPw, show: showConfirm, toggle: setShowConfirm },
  ];
