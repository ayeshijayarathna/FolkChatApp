...
export default function HelpCenterScreen({ navigation }: any) {
  ...
  // FAQ info pulled from language context
  const FAQ = [
    { q: t.faqQ1, a: t.faqA1 },
    { q: t.faqQ2, a: t.faqA2 },
    { q: t.faqQ3, a: t.faqA3 },
...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 22, fontWeight: 'bold', color:COLORS.gold, textAlign: 'center' },
  heroSub: { fontSize: 14, color:COLORS.rust, textAlign: 'center' },

  sectionTitle: {
    fontSize: 11, fontWeight: '700', letterSpacing: 1,
    marginHorizontal: 24, marginBottom: 8, marginTop: 8,
  },
  ...
  // Contact card — image replaces the mail icon
  contactCard: {
    margin: 16, borderRadius: 16, borderWidth: 0.5,
