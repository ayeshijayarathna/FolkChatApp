...
const styles = StyleSheet.create({
  ...
  overlay: { flex: 1, backgroundColor: 'rgba(44,36,24,0.15)' },
  container: { flex: 1, padding: 24, justifyContent: 'center' },
  back: { position: 'absolute', top: 60, left: 24 },
  backText: { color: COLORS.white, fontSize: 16, fontWeight: '600' },
  title: { fontSize: 32, fontWeight: 'bold', color: COLORS.white, marginBottom: 8, textAlign: 'center' },
  subtitle: { fontSize: 15, color: 'rgba(255,255,255,0.75)', textAlign: 'center', marginBottom: 32 },
  card: {
