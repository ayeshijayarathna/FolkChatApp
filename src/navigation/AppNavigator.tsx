...
const ChatScreen            = require('../screens/secondary/ChatScreen').default;
...
const AddStoryScreen        = require('../screens/secondary/AddStoryScreen').default;
const VoiceCallScreen       = require('../screens/call/VoiceCallScreen').default;
const VideoCallScreen       = require('../screens/call/VideoCallScreen').default;
...
export default function AppNavigator() {
  ...
  return (
    <NavigationContainer
      ...
      {/*IncomingCallListener only works when the user is logged in.Listens for calls and automatically goes to the call screen.*/}
